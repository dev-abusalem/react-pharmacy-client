            ...
            <table className="table table-hover">
              ...
              filteredMedicineData.map((medicine,i)=>{
                ...
                return(
                  ...
                  <td>{warning ? <strong style={{color:"orange"}}>{medicine.expairDate}</strong> : <strong>{medicine.expairDate}</strong>  && 
                  expired ? <strong style={{color:"red"}}>{medicine.expairDate}</strong> : <strong>{medicine.expairDate}</strong> }
                  </td>
                  <td><img src={medicine.mfeatureimage} alt={medicine.medicinename} /></td>
                  <td>
